...
const StudentDashboardPage = ({ studentData, courseData }) => {
  ...
  // Check if student with the specified ID exists
  if (!student) {
    return <div>Student not found</div>; // Handle the case where the student with the specified ID is not found
  }

  // Find the corresponding course data based on the student's course property
